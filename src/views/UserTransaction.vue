<template>
    <div class="card">
      ...
      <UserTrancModal :items="detailData" :show="loanModalVisible" :selectedItem="selectedItem" :mode="'update'" :selectedCode="selectedItem.code" @update:show="loanModalVisible = $event" 
  ...
  import UserTrancModal from '../components/UserTrancModal.vue';
